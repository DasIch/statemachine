...
# sphinx-quickstart on Wed Feb  2 16:43:09 2011.
#
...
project = u'Statemachine'
copyright = u'2011, Daniel Neuhäuser'
...
# documentation.
# html_theme_options = {
    # 'github_fork': 'DasIch/statemachine',
...
latex_documents = [
  ('index', 'Statemachine.tex', u'Statemachine Documentation',
...
man_pages = [
    ('index', 'statemachine', u'Statemachine Documentation',
